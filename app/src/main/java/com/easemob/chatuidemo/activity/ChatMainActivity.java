...
//					unreadAddressLable.setText(String.valueOf(count));
	...
	public int getUnreadAddressCountTotal() {
		...
		if (JudiApplication.getInstance().getContactList().get(Constant.NEW_FRIENDS_USERNAME) != null)
			unreadAddressCountTotal = JudiApplication.getInstance().getContactList().get(Constant.NEW_FRIENDS_USERNAME)
					.getUnreadMsgCount();
	...
	public class MyContactListener implements EMContactListener {
		...
		public void onContactAdded(List<String> usernameList) {			
			// 保存增加的联系人
			Map<String, User> localUsers = JudiApplication.getInstance().getContactList();
	...
	private void saveInviteMsg(InviteMessage msg) {
		...
		// 未读数加1
		User user = JudiApplication.getInstance().getContactList().get(Constant.NEW_FRIENDS_USERNAME);
		...
		if (!ChatMainActivity.this.isFinishing()) {
			...
			try {
				if (accountRemovedBuilder == null)
					accountRemovedBuilder = new android.app.AlertDialog.Builder(ChatMainActivity.this);
