...
public class RefreshListView extends ListView implements OnScrollListener {
	...
	private void initFooterView() {
		...
		footerViewHeight = footerView.getMeasuredHeight();//获取footerView的高度
		footerView.setPadding(0, -footerViewHeight, 0, 0);//隐藏尾布局
		this.addFooterView(footerView);// 向ListView的尾部添加尾布局
	}
	...
	private void initHeaderView() {
		...
		headerViewHeight = headerView.getMeasuredHeight();//获取headerView的高度
		headerView.setPadding(0, -headerViewHeight, 0, 0);//隐藏头布局
		this.addHeaderView(headerView); // 向ListView的顶部添加头布局
		initAnimation();
	}
